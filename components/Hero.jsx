            ...
            <div className="hero-container">
                <div className="hero-content">
                    ...
                    <p className="hero-description">
                        ...
                        with 3+ years of experience in API orchestration and generative AI integrations.
                    </p>
                    <div className="hero-cta">
                        ...
                        <a href="/resume/Afsha_Naaz_Ansari.pdf" className="btn btn-secondary" download>
                ...
                <div className="hero-image">
                    <div className="image-wrapper">
                        ...
                        <Image
                            src="/images/afsha.jpg"
                            alt="Afsha Naaz Ansari - Software Engineer"
                            width={380}
                            height={380}
