    ...
    const projects = [
        {
            ...
            description: 'Full-featured PDF SaaS platform serving 5,000+ monthly users. Features upload, edit, and access control, reducing manual media production time by 70% with automated SMTP notifications.',
        ...
        },
        {
            ...
            description: 'AI-powered music generation platform utilizing Suno and Uberduck APIs to process 1,000+ tracks monthly. Features payment integration and secure authentication.',
        ...
        },
        {
            ...
            description: 'A comprehensive MERN stack career portal handling 100+ concurrent job applications. Features streamlined job listings, dynamic applications, and role-based user management.',
